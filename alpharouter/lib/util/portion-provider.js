...
var PortionProvider = /** @class */ (function () {
    function PortionProvider() {
    }
    PortionProvider.prototype.getPortionAmount = function (tokenOutAmount, tradeType, tokenOutHasFot, swapConfig) {
        if (tokenOutHasFot || (swapConfig === null || swapConfig === void 0 ? void 0 : swapConfig.type) !== SwapType.UNIVERSAL_ROUTER) {
            return undefined;
        }
        var swapConfigUniversalRouter = swapConfig;
        switch (tradeType) {
            ...
            case TradeType.EXACT_OUTPUT:
                ...
                return undefined;
            default:
                throw new Error("Unknown trade type ".concat(tradeType));
        }
    };
    PortionProvider.prototype.getPortionQuoteAmount = function (tradeType, quote, portionAdjustedAmount, portionAmount) {
        if (!portionAmount) {
            return undefined;
        }
        ...
        var portionToPortionAdjustedAmountRatio = new Fraction(portionAmount.quotient, portionAdjustedAmount.quotient);
    ...
    PortionProvider.prototype.getRouteWithQuotePortionAdjusted = function (tradeType, routeWithQuotes, swapConfig) {
        var _this = this;
        ...
        return routeWithQuotes.map(function (routeWithQuote) {
            var _a;
            var tokenOut = routeWithQuote.tokenPath[routeWithQuote.tokenPath.length - 1];
            var tokenOutHasFot = tokenOut && ((_a = tokenOut.buyFeeBps) === null || _a === void 0 ? void 0 : _a.gt(0));
            var portionAmount = _this.getPortionAmount(routeWithQuote.quote, tradeType, tokenOutHasFot, swapConfig);
    ...
    PortionProvider.prototype.getQuote = function (tradeType, quote, portionQuoteAmount) {
        switch (tradeType) {
            case TradeType.EXACT_INPUT:
                return quote;
            case TradeType.EXACT_OUTPUT:
    ...
    PortionProvider.prototype.getQuoteGasAdjusted = function (tradeType, quoteGasAdjusted, portionQuoteAmount) {
        switch (tradeType) {
            case TradeType.EXACT_INPUT:
    ...
    PortionProvider.prototype.getQuoteGasAndPortionAdjusted = function (tradeType, quoteGasAdjusted, portionAmount) {
        if (!portionAmount) {
            return undefined;
        }
        switch (tradeType) {
